...
import makemesmilelogo from "/public/make_me_smile_logo.png"
import amreflogo from "/public/amref_logo.png"
import witevalogo from "/public/witeva_logo.png"
        ...
        className="testimonials_section">
            ...
            <div className="testimonials_container">
                <div className="testimonial_card">
                    <img src= {makemesmilelogo} alt="client" />
                ...
                <div className="testimonial_card">
                    <img src= {amreflogo} alt="client" style={{backgroundColor: "white"}}/>
                ...
                <div className="testimonial_card">
                    <img src={witevalogo} alt="client" style={{height: "80px", width: "80px"}} />
